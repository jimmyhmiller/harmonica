package com.jimmyhmiller.harmonica.jackson;
...
import com.jimmyhmiller.harmonica.jackson.mixins.NodeMixin;
...
public class AstModule extends SimpleModule {
    ...
    public AstModule() {
        super("AstModule", new Version(1, 0, 0, null, "com.jimmyhmiller.harmonica", "harmonica-jackson"));
    }
